package ru.propershop.ui.Admin;
...
import ru.propershop.ui.RegisterActivity;
...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inStockToggle = (ToggleSwitch) findViewById(R.id.in_stock);
        inStockToggle.setCheckedPosition(0);

        inStockToggle.setOnChangeListener(position -> {
            inStock = position == 0;
        });
    }
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("inStock", inStock);
